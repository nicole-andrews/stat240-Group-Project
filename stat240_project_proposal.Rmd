...
The effect of different weather conditions on the car accident rate. We believe that weather conditions such as rain, snow, and fog may increase the likelihood of car accidents. We aim to investigate the relationship between weather conditions and car accidents and determine if certain weather conditions are associated with higher accident rates.

In addition, we also believe millage is related to the accident rate. We will investigate the relationship between the millage and the number of accidents to see if there is a correlation between the two.
...
This data consist of car accidents in the United States, with detailed information about location, date, time, weather conditions, and the number of people involved. 
...
TODO: Add a description of the graph you plan to create.
