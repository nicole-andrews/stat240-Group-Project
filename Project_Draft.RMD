...
Since the Professor suggested we only covered the technique to determine a difference between exactly two groups. We summarize the No Injuries and Minor, into one group and the Moderate, Serious, and Fatality into another group.  
